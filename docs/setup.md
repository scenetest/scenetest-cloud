...
With `ENABLE_DEBUG_ROUTES = "1"` (default in wrangler.toml),
`POST /api/debug/stub-run` fabricates a run end-to-end without GitHub or
DigitalOcean — the fastest way to see the dashboard working.
